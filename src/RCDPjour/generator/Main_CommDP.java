...
public class Main_CommDP {
    public static void main(String[] args) {
        long startTime = System.currentTimeMillis();
        Code02_TrieTree_CommDP trie = new Code02_TrieTree_CommDP();
        ...
        // 2. 深拷贝原始树状态（加噪前）
        Code02_TrieTree_CommDP originalTree = trie.copyTree();
...
//        double mutualInfo = Code02_TrieTree_RCDP.calculateMutualInformation(originalTree.root, trie.root);
        double mutualInfo = Code02_TrieTree_CommDP.calculateNormalizedMutualInformation(originalTree.root, trie.root);
