...
public class Code02_TrieTree_CommDP {

    public Node root;
    private int originalSize; // 新增字段，记录原始数据总数

    //构造函数，初始化根节点
    public Code02_TrieTree_CommDP() {
        this.root = new Node();
        this.originalSize = 0;
    }
    ...
    // 深拷贝整棵树
    public Code02_TrieTree_CommDP copyTree() {
        Code02_TrieTree_CommDP copy = new Code02_TrieTree_CommDP();
...
//
    ...
    public static List<String> generateWordsFromTrie(Code02_TrieTree_CommDP trie) {
